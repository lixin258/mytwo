    ...
    auiDialog.prototype = {
        ...
        create: function(params,callback) {
            ...
            if(params.input){
                ...
                var msgHtml = '<div class="aui-dialog-body"><input type="'+params.inputType+'" placeholder="'+params.text+'"></div>';
            }else{
            ...
            if (buttons && buttons.length > 0) {
                for (var i = 0; i < buttons.length; i++) {
                    buttonsHtml += '<div class="aui-dialog-btn tab-active" tapmode button-index="'+i+'">'+buttons[i]+'</div>';
                }
            }
